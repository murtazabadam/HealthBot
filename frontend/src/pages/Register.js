...
export default function Register() {
  ...
  const handleContinue = async (e) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Backend crashed or is offline.");
      }
      ...
      if (err.message === "Failed to fetch") {
        setErrorMessage("Server is asleep. Please wake up the backend.");
      } else {
  ...
  const handleFinalRegister = async (e) => {
    ...
    try {
      ...
      if (!verifyRes.ok)
        throw new Error(verifyData.message || "Invalid OTP. Try again.");
  ...
  return (
    <div className="min-h-screen bg-[#0B1120] font-sans text-slate-50 relative flex flex-col items-center overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col justify-center items-center w-full px-4 z-10 my-10">
        <div className="bg-[#111827]/80 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-6 sm:p-12 w-full max-w-[850px] shadow-2xl relative transition-all duration-500">
                ...
                <div className="text-center mt-4">
                  <p className="text-sm text-slate-400">
                    ...
                    <button
                      ...
                      className="text-teal-400 font-bold hover:underline disabled:opacity-50 disabled:no-underline ml-1"
                    >
