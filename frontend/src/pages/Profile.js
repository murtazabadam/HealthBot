...
export default function Profile() {
  ...
  // Password toggle states (All 3 included!)
    ...
    <div className="min-h-screen bg-[#0B1120] font-sans text-slate-50 relative overflow-x-hidden w-full">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-4 sm:px-6 py-4 lg:px-12 w-full bg-[#0B1120]/80 backdrop-blur-md border-b border-slate-800/50">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <Link
            to="/chat"
            className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-slate-400 hover:text-teal-400 transition-colors font-bold"
          >
          ...
          <button
            onClick={logout}
            className="text-xs text-slate-500 hover:text-red-400 transition-colors font-bold"
          >
            Logout
          </button>
        </div>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 sm:py-10 z-10 relative">
        ...
        {/* Change Password Card - Simple Design with 3 Eyes! */}
