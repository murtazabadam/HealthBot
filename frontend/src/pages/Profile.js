...
export default function Profile() {
  ...
  const [showConfirmPw, setShowConfirmPw] = useState(false); // Added for the 3rd Eye icon
    ...
    <div className="min-h-screen bg-[#0B1120] font-sans text-slate-50">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 lg:px-12 w-full bg-[#0B1120]/80 backdrop-blur-md border-b border-slate-800/50">
        ...
        <div className="flex items-center gap-4">
          <Link to="/chat" className="flex items-center gap-2 text-sm text-slate-400 hover:text-teal-400 transition-colors">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 z-10 relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              {editing ? (
                ...
                <p className="text-white text-sm py-3 px-4 bg-slate-800/30 rounded-xl">{profile?.name || "—"}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-400 text-sm py-3 px-4 bg-slate-800/30 rounded-xl flex items-center gap-2">
                {profile?.email}
                {profile?.isVerified && <CheckCircle2 className="h-4 w-4 text-green-400" />}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              {editing ? (
                ...
                <p className="text-white text-sm py-3 px-4 bg-slate-800/30 rounded-xl">{profile?.phoneNumber || "—"}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              {editing ? (
                ...
                <p className="text-white text-sm py-3 px-4 bg-slate-800/30 rounded-xl">{profile?.age || "—"}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              {editing ? (
                ...
                <p className="text-white text-sm py-3 px-4 bg-slate-800/30 rounded-xl capitalize">{profile?.gender || "—"}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              {editing ? (
                ...
                <p className="text-white text-sm py-3 px-4 bg-slate-800/30 rounded-xl">{profile?.bloodGroup || "—"}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-2 sm:col-span-2">
              ...
              {editing ? (
                ...
                <p className="text-white text-sm py-3 px-4 bg-slate-800/30 rounded-xl">{profile?.address || "—"}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#111827]/80 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8">
          ...
          {!showPasswordForm ? (
            <p className="text-slate-400 text-sm">Your password is securely encrypted. Click "Change Password" to update it.</p>
          ) : (
