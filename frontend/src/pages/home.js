...
export default function Home() {
  return (
    /* Removed min-w-[1024px] so phones can shrink normally. overflow-x-hidden prevents side-scrolling */
    <div className="min-h-screen bg-[#0B1120] font-sans text-slate-50 selection:bg-teal-500 selection:text-white overflow-x-hidden relative w-full">
      ...
      <div className="absolute top-0 left-1/4 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-teal-500/10 rounded-full blur-[80px] md:blur-[120px] pointer-events-none" />
      <div className="absolute top-40 right-1/4 w-[250px] md:w-[400px] h-[250px] md:h-[400px] bg-cyan-500/10 rounded-full blur-[60px] md:blur-[100px] pointer-events-none" />
      ...
      <nav className="flex items-center justify-between px-6 py-4 lg:px-12 lg:py-5 border-b border-slate-800/60 bg-[#0B1120]/80 backdrop-blur-md fixed w-full top-0 z-50">
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <Link to="/register" className="px-4 py-2 lg:px-6 lg:py-2.5 text-xs lg:text-sm font-semibold text-slate-900 bg-teal-400 hover:bg-teal-300 rounded-md transition-all shadow-[0_0_15px_rgba(45,212,191,0.2)]">
            Sign Up
          </Link>
        </div>
      </nav>
      ...
      <main className="relative pt-32 pb-12 px-6 lg:pt-44 lg:px-12 max-w-[1200px] mx-auto flex flex-col items-center text-center z-10">
        ...
        {/* Heading - Allowed to wrap on mobile, stays on one line on desktop */}
        <h1 className="text-4xl sm:text-5xl lg:text-[4rem] font-extrabold tracking-tight text-white mb-6 leading-[1.1] lg:whitespace-nowrap">
          Your AI-Powered <br className="block sm:hidden" /> <span className="text-teal-400">Health</span> Assistant
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 w-full sm:w-auto">
          <Link to="/chat" className="w-full sm:w-auto px-8 py-3.5 text-base font-bold text-slate-900 bg-teal-400 hover:bg-teal-300 rounded-full transition-all flex items-center justify-center gap-2">
        ...
        {/* Trust Badges - Flex wrap so they stack on small screens nicely */}
        <div className="flex flex-wrap items-center justify-center gap-4 lg:gap-8 pt-8 border-t border-slate-800/50 w-full max-w-3xl mx-auto">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs lg:text-sm font-medium text-slate-200">Secure & Private</span>
          </div>
          <div className="flex items-center gap-2">
            <Clock className="h-4 w-4 lg:h-5 lg:w-5 text-blue-400" />
            <span className="text-xs lg:text-sm font-medium text-slate-200">Instant Support</span>
          </div>
          <div className="flex items-center gap-2">
            <Brain className="h-4 w-4 lg:h-5 lg:w-5 text-purple-400" />
            <span className="text-xs lg:text-sm font-medium text-slate-200">AI-Powered</span>
          </div>
          <div className="flex items-center gap-2">
            <Activity className="h-4 w-4 lg:h-5 lg:w-5 text-rose-400" />
            <span className="text-xs lg:text-sm font-medium text-slate-200">24/7 Available</span>
          </div>
        </div>
      </main>

      {/* Features Section - Responsive Grid */}
      <section id="features" className="pt-8 pb-8 px-6 lg:px-12 relative z-20 max-w-[1400px] mx-auto">
        ...
        {/* Grid dynamically changes columns based on screen size */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-[#111827] rounded-2xl p-6 lg:p-8 border border-slate-800 hover:border-teal-500/50 transition-all group text-left">
            ...
            <h3 className="text-lg lg:text-xl font-bold mb-3 text-white">AI Symptom Checker</h3>
          ...
          <div className="bg-[#111827] rounded-2xl p-6 lg:p-8 border border-slate-800 hover:border-blue-500/50 transition-all group text-left">
            ...
            <h3 className="text-lg lg:text-xl font-bold mb-3 text-white">Smart Recommendations</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <div className="bg-[#111827] rounded-2xl p-6 lg:p-8 border border-slate-800 hover:border-purple-500/50 transition-all group text-left">
            ...
            <h3 className="text-lg lg:text-xl font-bold mb-3 text-white">Health History</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <div className="bg-[#111827] rounded-2xl p-6 lg:p-8 border border-slate-800 hover:border-rose-500/50 transition-all group text-left">
            ...
            <h3 className="text-lg lg:text-xl font-bold mb-3 text-white">Nearby Facilities</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
      ...
      <footer className="border-t border-slate-800/60 py-8 px-6 lg:px-12 flex flex-col items-center justify-center w-full">
        ...
        <div className="flex items-center gap-2 opacity-80 mb-4">
          ...
          <span className="text-lg lg:text-xl font-bold text-slate-300">HealthBot</span>
        </div>

        {/* Copyright text at the bottom */}
        <p className="text-slate-400 text-xs lg:text-sm font-medium text-center">
